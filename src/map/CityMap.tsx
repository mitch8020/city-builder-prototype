...
interface SceneCallbacks {
  onSelect: CityMapProps['onSelect']
  onHover: CityMapProps['onHover']
  onStatus: CityMapProps['onStatus']
  onAnchor: CityMapProps['onAnchor']
  onModeShortcut: CityMapProps['onModeShortcut']
  onEscape: CityMapProps['onEscape']
}
...
class NashvilleScene implements CityMapController {
  ...
  updateCallbacks(callbacks: SceneCallbacks) {
    this.callbacks = callbacks
  }
