...
| UI-06 | Network pill                                                  | Shows “Google map” when attributed Google tiles work and “Local map” when the remote basemap fails.                                                             | Partial and complete Google outage; local parcel controls remain usable.                 |
